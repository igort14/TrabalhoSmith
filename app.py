...
if uploaded_file is not None:
    ...
    try:
        ...
        st.info("ℹ️ Nenhum arquivo enviado. Carregado arquivo local padrão: `dados_padrao.xlsx`")
    except FileNotFoundError:
        st.error(" Nenhum arquivo enviado e `dados_padrao.xlsx` não foi encontrado.")
        st.stop()
